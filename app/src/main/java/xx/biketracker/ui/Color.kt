...
// Grey for the primary button while the ride is being written to the database: for that moment it
// commands nothing, so it drops its color. Dark enough to read as a button against the light
// window, light enough against the dark one.
val SavingGrey = Color(0xFF616161)
